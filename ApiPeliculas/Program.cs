...
{
    //build.WithOrigins("http://localhost:3223").AllowAnyMethod().AllowAnyHeader(); //linea original
    // build.WithOrigins("http://localhost:7085").AllowAnyMethod().AllowAnyHeader(); //add // permitir solo una direccion
    build.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader(); //add // cualquier dominio
}));
